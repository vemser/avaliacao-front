...
import { IProgramas, IObjectProgramas, IProgramaContext, IProgramaCompleto } from "../../utils/programaInterface"
...
export const ProgramaProvider = ({ children }: IChildren) => {
  ...
  return (
    <ProgramaContext.Provider value={{ programas, cadastrarPrograma, pegarPrograma, deletarProgama, editarPrograma, pegarProgramaPorNome, pegarProgramaFiltroID, pegarProgramaAtivo, pegarProgramaPorNomeAtivo, clonarPrograma, programaCompleto, pegarProgramaCompleto }}>
      {children}
