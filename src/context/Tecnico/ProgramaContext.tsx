...
export const ProgramaProvider = ({ children }: IChildren) => {
  ...
  return (
    <ProgramaContext.Provider value={{ programas, cadastrarPrograma, pegarPrograma, deletarProgama, editarPrograma, pegarProgramaPorNome, mudaDashboard, setMudaDashboard, pegarProgramaAtivo }}>
      {children}
