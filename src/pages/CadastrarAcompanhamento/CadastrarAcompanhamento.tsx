  ...
  return (
    <Box component="section" sx={{ display: "flex", flexDirection: "column", alignItems: "center", minHeight: "calc(100vh - 64px)", paddingTop: "80px", paddingBottom: "50px" }}>
      ...
      <Box component="form" onSubmit={handleSubmit(cadastrarAcompanhamento)} sx={{
        display: { xs: "flex", md: "flex" }, flexDirection: "column", alignItems: "center", backgroundColor: "var(--branco)", width: { xs: "90%", md: "70%", lg: "50%" }, borderRadius: "10px", padding: {
          xs: 5, md: 5
        ...
        <Box sx={{ display: "flex", alignItems: "end", bottom: 0, paddingTop: "20px", gap: 2, flexDirection: { xs: "column", md: "row" } }}>
