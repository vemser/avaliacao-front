  ...
  return (
    <Box component="section" sx={{ display: "flex", flexDirection: "column", alignItems: "center", minHeight: "100vh", paddingTop: "80px", paddingBottom: "50px" }}>
      ...
      <Box component="form" sx={{ display: "flex", flexDirection: { xs: "column", lg: "row" }, justifyContent: "space-between", backgroundColor: "var(--branco)", width: { xs: "95%", md: "90%", lg: "85%" }, borderRadius: "10px", padding: { xs: 3, sm: 5 }, boxShadow: "5px 5px 10px var(--azul-escuro-dbc)", gap: { xs: 3, xl: 8 } }}>
        ...
        <Stack component="div" spacing={2} sx={{ width: { xs: "100%", lg: "70%" }, display: "flex", alignItems: { xs: "start", md: "start" } }}>
          <Typography sx={{ color: "var(--azul-claro-dbc)", fontWeight: '700', display: 'flex', alignItems: 'center', gap: 1 }}><AutoStories /> Atividade 01 - React Context</Typography>

          <Typography><strong>Instrutor: </strong> <span style={{ textTransform: 'capitalize' }}>{nome[0]} {nome[1]}</span></Typography>

          <Typography sx={{ display: 'flex', flexWrap: { xs: 'wrap' }, gap: { xs: 2 }, justifyContent: 'space-between', width: '100%' }}><span><strong>Peso/Nota:</strong> 0/10</span> <span><strong>Data de entrega:</strong> 06/01 de 2023 14:00</span></Typography>
