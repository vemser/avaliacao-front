    ...
    <Box component="section" sx={{ display: "flex", flexDirection: "column", alignItems: "center", minHeight: "calc(100vh - 64px)", paddingTop: "80px", paddingBottom: "50px" }}>
      ...
      <Box component="form" sx={{
        ...
        <FormControl sx={{ width: "100%" }}>
          <TextField id="editar-nome-trilha" label="Nome da Trilha" defaultValue={state.nome} variant="filled" />
        </FormControl>
        <FormControl sx={{ width: "100%" }}>
          <TextField id="editar-descricao-trilha" label="Descrição da Trilha" multiline rows={4} defaultValue={state.descricao} variant="filled" />
        </FormControl>
